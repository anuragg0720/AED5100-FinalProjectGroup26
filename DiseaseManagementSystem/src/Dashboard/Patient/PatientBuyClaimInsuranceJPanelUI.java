...
public class PatientBuyClaimInsuranceJPanelUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, 620, 167));
        ...
        add(txtPatientEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, 260, -1));

        jButton3.setBackground(new java.awt.Color(0, 0, 0));
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Claim Insurance");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 510, 150, 30));

        jLabel3.setText("Please enter your Email ID:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 360, -1, 20));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Dashboard/Patient/bg2 small.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 0, 860, 870));
    ...
    if (txtPatientEmail.getText().isEmpty()) {
        JOptionPane.showMessageDialog(this, 
            "Please enter your email address to process the claim", 
            "Email Required", 
    ...
    if ("Claimed".equals(currentStatus)) {
        JOptionPane.showMessageDialog(this, 
            "You have already claimed this insurance. Cannot claim again.", 
            "Already Claimed", 
    ...
    if (!"Pending".equals(currentStatus) && !"Approved".equals(currentStatus)) {
        JOptionPane.showMessageDialog(this, 
            "Your insurance request is currently: " + currentStatus + "\nPlease wait for approval before claiming.", 
            "Cannot Claim", 
            JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    int confirm = JOptionPane.showConfirmDialog(this, 
        ...
        "Premium: $" + patient.getInsuranceAdmin().getPremium() + "\n" +
